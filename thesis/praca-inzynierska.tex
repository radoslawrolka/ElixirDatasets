...
\begin{itemize}
    ...
    \item \textbf{Moduł networkingowy} – implementacja funkcji odpowiedzialnych za pobieranie danych z zewnętrznych źródeł poprzez protokół HTTP/HTTPS.
...
\begin{itemize}
    ...
    \item \textbf{Pokrycie testami} – monitorowanie i utrzymanie wysokiego poziomu pokrycia kodu testami (target: 80\%) z wykorzystaniem ExCoveralls.
\end{itemize}
...
Narzędzie do tworzenia interaktywnych notatników w Elixirze, wykorzystane do
