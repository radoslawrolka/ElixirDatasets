...
\begin{figure}[!htbp]
  ...
  \caption{Zrzut strony HuggingFace Datasets}
  \label{fig:huggingface-datasets}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Wydajność} – Biblioteka powinna umożliwiać efektywne operacje na dużych zbiorach danych, takich jak filtrowanie, czyszczenie czy transformacja. Szczególny nacisk powinien zostać położony na optymalizację operacji na dużych zbiorach danych oraz minimalizację zużycia pamięci i czasu przetwarzania.
...
\caption{Dokumentacja w edytorze kodu}
\label{fig:progressbar}
\end{figure}
...
\newline \par
Przykładem wykorzystania etagu oraz OId może być kontrola stanu zbiorów danych na zdalnym repozytorium. Poniżej przedstawiono przykłady odpowiedzi serwera, ilustrującej zastosowanie etagu i OId:
...
\caption{Przykład wizualizacji paska postępu}
\label{fig:progressbar}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Transformacja danych} – implementacja funkcji do wczytywania i przetwarzania danych z różnych formatów.
...
\begin{figure}[!htbp]
  ...
  \caption{Publikacja biblioteki w hex}
  \label{fig:hex-publication}
\end{figure}

\FloatBarrier

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Główne scenariusze użytkowania}
...
\begin{figure}[!htbp]
  ...
  \caption{Przykład z livebook - ładowanie z Hugging Face}
  \label{fig:loading-hf}
\end{figure}

\begin{figure}[!htbp]
  \centering
  \includegraphics[width=.9\textwidth]{zdjęcia/ladowanie3.png}
  \caption{Przykład z livebook - ładowanie z podanego folderu}
  \label{fig:loading-folder}
\end{figure}

\begin{figure}[!htbp]
  \centering
  \includegraphics[width=.9\textwidth]{zdjęcia/ladowanie4.png}
  \caption{Przykład z livebook - ładowanie z tokenem autoryzacyjnym}
  \label{fig:loading-auth}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption{Przykład z livebook}
  \label{fig:loading-local}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption{Przykład z livebook - offline mode}
  \label{fig:offline-mode}
\end{figure}

\begin{figure}[!htbp]
  \centering
  \includegraphics[width=.9\textwidth]{zdjęcia/cache.png}
  \caption{Przykład z livebook - używanie podanego folderu jako cache}
  \label{fig:cache-folder}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption{Przykład z livebook - wykorzystanie streamingu}
  \label{fig:streaming}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \caption{Przykład z livebook - ładowanie wielowątkowe}
...
\begin{figure}[!htbp]
  ...
  \caption{Przykład z livebook - publikowanie zbioru danych}
  \label{fig:upload-hf-1}
\end{figure}
